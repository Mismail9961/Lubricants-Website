...
export default function AxionLegacy() {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
                    ...
                    <div className="col-span-1 md:col-span-6 lg:col-span-5 flex flex-col gap-6 md:gap-8 opacity-0 animate-slide-left">
                        <div className="flex flex-col gap-4">
                            <p className="text-[15px] xs:text-[16px] sm:text-[18px] lg:text-[20px] xl:text-[22px] leading-relaxed text-gray-800 font-normal tracking-wide">
                                Born from Carmetra’s legacy of resilience and innovation, AXION Lubricants represents the next chapter in high-performance engine care. Where Carmetra laid the foundation, AXION builds with precision.
                            </p>
                        </div>

                        <div className="flex flex-col gap-4">
                            <p className="text-[15px] xs:text-[16px] sm:text-[18px] lg:text-[20px] xl:text-[22px] leading-relaxed text-gray-800 font-normal tracking-wide">
                                We launched AXION to answer a clear need: a lubricant brand that could meet the evolving demands of modern engines - without compromise. In markets often underserved by quality or burdened by cost, AXION delivers both reliability and advanced performance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-6 lg:col-span-7 opacity-0 animate-slide-right [animation-delay:0.2s]">
                        <div className="w-full h-auto overflow-hidden rounded-[24px] sm:rounded-[32px] shadow-lg md:shadow-xl">
                            <img
                                src="https://axionlubricants.com/Images/AboutImage1.webp" /* Replace with your local image route or asset path */
                                alt="AXION City Skyline Landscape"
