                    ...
                    <div className="col-span-1 md:col-span-6 lg:col-span-5 flex flex-col gap-6 md:gap-8 opacity-0 animate-slide-left">
                        <div className="flex flex-col gap-4">
                            <p className="text-[15px] xs:text-[16px] sm:text-[18px] lg:text-[20px] xl:text-[22px] leading-relaxed text-gray-800 font-normal tracking-wide">
                                Born from a deep-rooted history of resilience and technological innovation, PROTECT represents the next generation in high-performance industrial care. Building upon a foundation of engineering excellence, PROTECT designs with total precision.
                            </p>
                        </div>

                        <div className="flex flex-col gap-4">
                            <p className="text-[15px] xs:text-[16px] sm:text-[18px] lg:text-[20px] xl:text-[22px] leading-relaxed text-gray-800 font-normal tracking-wide">
                                We launched PROTECT to answer a clear need: a brand that could meet the evolving demands of modern industries - without compromise. In markets often underserved by quality or burdened by cost, PROTECT delivers both absolute reliability and advanced performance.
                            </p>
                        </div>
                    </div>
